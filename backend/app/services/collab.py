        ...
        try:
            ...
            while True:
                ...
                if msg_type == "edit":
                    ...
                    # Open a fresh session for each DB write so the
                    # session is never stale from a previous transaction
                    async with AsyncSessionLocal() as save_db:
                        await apply_and_broadcast(doc_id, user_id, delta, save_db)
            ...
            async with AsyncSessionLocal() as save_db:
                await persist_doc(doc_id, save_db)
